          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-4">
              <button
                ...
                className="relative inline-flex items-center justify-center px-6 py-2.5 rounded-full text-sm font-bold text-white bg-[#0b294f] hover:bg-[#0b294f]/90 transition-all duration-300 shadow-md hover:shadow-lg hover:shadow-[#0b294f]/15 overflow-hidden group border border-transparent hover:border-[#67b32f]"
              >
          ...
          <div className="md:hidden absolute top-20 left-0 w-full bg-white border-b border-gray-100 shadow-xl transition-all duration-300 animate-in slide-in-from-top">
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 px-4">
                <button
                  onClick={() => handleTabChange("contact")}
                  className="w-full py-3 rounded-full text-center text-sm font-extrabold text-white bg-[#0b294f] hover:bg-[#67b32f] transition-all duration-300"
                >
                  Start a Project
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                  ...
                  <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                      <button
                        onClick={() => handleTabChange("contact")}
                        className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-white bg-[#0b294f] hover:bg-[#67b32f] transition-all duration-300 shadow-lg shadow-[#0b294f]/20 hover:shadow-[#67b32f]/20 flex items-center justify-center gap-2"
                      >
                        Initiate Consultation <ArrowUpRight className="w-5 h-5" />
                      </button>
                      <button
                        onClick={() => handleTabChange("solutions")}
                        className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 transition-all duration-300 flex items-center justify-center gap-2"
                      >
                        Explore Solutions
                      </button>
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 sm:p-12 md:p-16 items-center">
                    <div className="space-y-6 text-white text-left">
                      ...
                      <div className="pt-4 flex flex-wrap gap-4">
                        <button
                          onClick={() => handleTabChange("solutions")}
                          className="px-6 py-3 rounded-full text-sm font-bold bg-[#67b32f] hover:bg-white hover:text-[#0b294f] transition-all duration-300 flex items-center gap-2"
                        >
          ...
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-16 bg-[#0b294f]/5 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button
                  onClick={() => handleTabChange("contact")}
                  className="px-6 py-3 rounded-full text-sm font-extrabold text-white bg-[#0b294f] hover:bg-[#67b32f] transition-all"
                >
              ...
              <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
                ...
                <div className="pt-6 max-w-md mx-auto">
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Search active portals or modules..."
                      value={solutionSearch}
                      onChange={(e) => setSolutionSearch(e.target.value)}
                      className="w-full pl-10 pr-4 py-3 rounded-full bg-white border border-gray-200 focus:outline-none focus:border-[#67b32f] text-sm text-[#0b294f]"
                    />
              ...
              {team.slice(0, 1).map((leader, idx) => (
                ...
                >
                  <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left space-y-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-[#0b294f]">{leader.name}</h3>
                      <p className="text-sm font-bold text-[#67b32f] uppercase tracking-wider">{leader.role}</p>
                    </div>
                  </div>
                    ...
                    {formSubmitted ? (
                      <div className="text-center py-12 space-y-6">
                        ...
                        <button
                          ...
                          className="px-6 py-2.5 rounded-full text-xs font-bold text-[#0b294f] bg-[#67b32f]/10 hover:bg-[#67b32f]/20 transition-all"
                        >
                      ...
                      <form onSubmit={handleFormSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          <div className="space-y-1.5">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#67b32f] text-sm text-[#0b294f]"
                            />
                          </div>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <select
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#67b32f] text-sm text-[#0b294f] font-medium"
                          >
                        ...
                        <div className="space-y-1.5">
                          ...
                          <textarea
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#67b32f] text-sm text-[#0b294f] placeholder:text-gray-400"
                          />
                        </div>

                        <button
                          type="submit"
                          className="w-full py-4 rounded-xl font-bold text-white bg-[#0b294f] hover:bg-[#67b32f] transition-all duration-300 flex items-center justify-center gap-2 shadow-md shadow-[#0b294f]/10"
                        >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 text-left">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center gap-3" onClick={() => handleTabChange("home")}>
